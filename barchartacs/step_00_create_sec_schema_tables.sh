...
# $ bash step_00_create_sec_schema_tables.sh ~/Virtualenvs3/dashrisk3 secdb_aws test 
#
# example with virtualenv=~/Virtualenvs3/dashrisk3, db config_name=secdb_aws live mode (CREATE tables)
# $ bash step_00_create_sec_schema_tables.sh ~/Virtualenvs3/dashrisk3 secdb_aws live 
#
